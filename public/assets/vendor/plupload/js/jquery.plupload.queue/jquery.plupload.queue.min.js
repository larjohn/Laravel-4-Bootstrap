        ...
        return i ? (this.each(function () {
            ...
            function l() {
                ...
                e.each(s.files, function (n, o) {
                    i = "", o.status == plupload.DONE && (o.target_name && (i += '<input type="hidden" name="' + u + "_" + r + '_tmpname" value="' + plupload.xmlEncode(o.target_name) + '" />'), i += '<input type="hidden" name="' + u + "_" + r + '_name" value="' + plupload.xmlEncode(o.name) + '" />', i += '<input type="hidden" name="' + u + "_" + r + '_status" value="' + (o.status == plupload.DONE ? "done" : "failed") + '" />', r++, e("#" + u + "_count").val(r)), t.append('<li id="' + o.id + '">' + '<div class="plupload_file_name"><span>' + o.name + "</span></div>" + '<div class="plupload_file_action"><a href="#"></a></div>' + '<div class="plupload_file_status">' + o.percent + "%</div>" + '<div class="plupload_file_size">' + plupload.formatSize(o.size) + "</div>" + '<div class="plupload_clearer">&nbsp;</div>' + i + "</li>"), a(o), e("#" + o.id + ".plupload_delete a").click(function (t) {
                        e("#" + o.id).remove(), s.removeFile(o), t.preventDefault()
                    })
                }), e("span.plupload_total_file_size", o).html(plupload.formatSize(s.total.size)), s.total.queued === 0 ? e("span.plupload_add_text", o).html(n("Add Files")) : e("span.plupload_add_text", o).html(n("%d files queued").replace(/%d/, s.total.queued)), e("a.plupload_start", o).toggleClass("plupload_disabled", s.files.length == s.total.uploaded + s.total.failed), t[0].scrollTop = t[0].scrollHeight, f(), !s.files.length && s.features.dragdrop && s.settings.dragdrop && e("#" + u + "_filelist").append('<li class="plupload_droptext">' + n("Drag files here.") + "</li>")
            }

            var s, o, u;
            o = e(this), u = o.attr("id"), u || (u = plupload.guid(), o.attr("id", u)), s = new plupload.Uploader(e.extend({dragdrop: !0, container: u}, i)), t[u] = s, s.bind("UploadFile", function (t, n) {
                e("#" + n.id).addClass("plupload_current_file")
            }), s.bind("Init", function (t, n) {
                r(u, o), !i.unique_names && i.rename && o.on("click", "#" + u + "_filelist div.plupload_file_name span", function (n) {
                ...
                }), e("a.plupload_add", o).attr("id", u + "_browse"), t.settings.browse_button = u + "_browse", t.settings.dragdrop && (t.settings.drop_element = u + "_filelist"), e("#" + u + "_container").attr("title", "Using runtime: " + n.runtime), e("a.plupload_start", o).click(function (t) {
            ...
            }), s.init(), s.bind("Error", function (t, r) {
                var i = r.file, s;
                i && (s = r.message, r.details && (s += " (" + r.details + ")"), r.code == plupload.FILE_SIZE_ERROR && alert(n("Error: File too large:") + " " + i.name), r.code == plupload.FILE_EXTENSION_ERROR && alert(n("Error: Invalid file extension:") + " " + i.name), i.hint = s, e("#" + i.id).attr("class", "plupload_failed").find("a").css("display", "block").attr("title", s))
            ...
            }), s.bind("QueueChanged", l), s.bind("FileUploaded", function (e, t) {
                a(t)
            }), s.bind("UploadProgress", function (t, n) {
                e("#" + n.id + " div.plupload_file_status", o).html(n.percent + "%"), a(n), f(), i.multiple_queues && s.total.uploaded + s.total.failed == s.files.length && (e(".plupload_buttons,.plupload_upload_status", o).css("display", "inline"), e(".plupload_start", o).addClass("plupload_disabled"), e("span.plupload_total_status,span.plupload_total_file_size", o).hide())
            }), i.setup && i.setup(s)
